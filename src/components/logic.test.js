...
test('Removing product properly', () => {
    ...
    myShopping.deleteProductFromCategory(myShopping.categoryList[1].productList[0], myShopping.categoryList[1]);
...
test('Removing multiply product properly', () => {
    ...
    myShopping.deleteProductFromCategory(myShopping.categoryList[1].productList[1], myShopping.categoryList[1]);
    myShopping.deleteProductFromCategory(myShopping.categoryList[1].productList[0], myShopping.categoryList[1]);
    myShopping.deleteProductFromCategory(myShopping.categoryList[0].productList[0], myShopping.categoryList[0]);
